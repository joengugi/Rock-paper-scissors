...
button_rock = Button(text = "  ROCK ", bg = "gray", font = ("arial",15, "italic bold"), relief = RIDGE,
    activebackground = "#059458", activeforeground = "white", width = 24, command= 'rock')
button_rock.grid( column = 0, row = 1)

button_paper = Button(text = "  PAPER ", bg = "white", font = ("arial",15, "italic bold"), relief = RIDGE,
    activebackground = "#059458", activeforeground = "white", width = 24, command= 'paper' )
button_paper.grid( column = 0, row = 2)

button_scissors = Button(text = "  SCISSORS ", bg = "yellow", font = ("arial",15, "italic bold"), relief = RIDGE,
